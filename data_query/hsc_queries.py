...
def write_fieldsearch(tablename,fieldname,fname_out,output_format="fits",
    ...
    stout+="       ,c.ishape_hsm_moments_11 as ishape_hsm_moments_11\n"
    stout+="       ,c.ishape_hsm_moments_22 as ishape_hsm_moments_22\n"
    stout+="       ,c.ishape_hsm_moments_12 as ishape_hsm_moments_12\n"
    stout+="       ,c.ishape_hsm_psfmoments_11 as ishape_hsm_psfmoments_11\n"
    stout+="       ,c.ishape_hsm_psfmoments_22 as ishape_hsm_psfmoments_22\n"
    stout+="       ,c.ishape_hsm_psfmoments_12 as ishape_hsm_psfmoments_12\n"
    if w_lensing:
        stout+="       ,a.clean_photometry as clean_photometry\n"
        stout+="       ,a.wl_fulldepth_fullcolor as wl_fulldepth_fullcolor\n"
