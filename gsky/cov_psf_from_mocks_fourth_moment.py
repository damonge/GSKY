...
class CovPSFFromMocksFourthMoment(object):
    ...
    def go(self):
        config={'plots_dir': None,
          ...
          'clean_catalog_data': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/HECTOMAP_ceci/catalog2/clean_catalog.fits',
    ...
    def __call__(self, realization):
        config={'plots_dir': None,
          ...
          'clean_catalog_data': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/HECTOMAP_ceci/catalog2/clean_catalog.fits',
          'mock_correction_factors': '/tigress/rdalal/fourier_space_shear/mocks_correction_factor.npy',
          'psf_residual_map': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/HECTOMAP_ceci/catalog2/ePSFres_map_psf_used.fits',
          'psf_leakage_map': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/HECTOMAP_ceci/catalog2/ePSF_map_psf_used.fits',
          'm4_psf_residual_map': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/HECTOMAP_ceci/catalog2/M4_PSFres_map_psf_used.fits',
          'm4_psf_leakage_map': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/HECTOMAP_ceci/catalog2/M4_PSF_map_psf_used.fits'}
