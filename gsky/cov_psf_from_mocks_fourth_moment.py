...
class CovPSFFromMocksFourthMoment(object):
    ...
    def __call__(self, realization):
        config={'plots_dir': None,
          ...
          'm4_psf_residual_map': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/GAMA15H_ceci/M4_PSFres_map_psf_used.fits',
          'm4_psf_leakage_map': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/GAMA15H_ceci/M4_PSF_map_psf_used.fits'}
