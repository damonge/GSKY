...
class NoiseBiasFromMocks(object):
    ...
    def go(self):
        config={'plots_dir': None,
          ...
          'star_catalog': '/projects/HSC/weaklens/s19a_shape_catalog/star_catalog_higher_moments/GAMA09H_nonpsf.csv'}
    ...
    def __call__(self, realization):
        config={'plots_dir': None,
          ...
          'shape_noise': True,
          'rm_gama09h_region': True,
          'masked_fraction': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/GAMA09H_ceci/masked_fraction_rm20sqdeg.fits',
          'star_catalog': '/projects/HSC/weaklens/s19a_shape_catalog/star_catalog_higher_moments/GAMA09H_nonpsf.csv'}
