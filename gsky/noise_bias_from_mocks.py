...
class NoiseBiasFromMocks(object):
    ...
    def go(self):
        config={'plots_dir': None,
          ...
          'star_catalog': '/projects/HSC/weaklens/s19a_shape_catalog/star_catalog_higher_moments/HECTOMAP_nonpsf.csv'}
    ...
    def __call__(self, realization):
        config={'plots_dir': None,
          ...
          'shape_noise': True,
          'rm_gama09h_region': True,
          'masked_fraction': '/tigress/rdalal/fourier_space_shear/GSKY_outputs/HECTOMAP_ceci/masked_fraction.fits',
          'star_catalog': '/projects/HSC/weaklens/s19a_shape_catalog/star_catalog_higher_moments/HECTOMAP_nonpsf.csv'}
