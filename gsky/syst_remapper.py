...
class SystReMapper(PipelineStage) :
    ...
    inputs=[('airmass_maps',HspFile),('exptime_maps',HspFile),
             ('skylevel_maps',HspFile),('sigma_sky_maps',HspFile),('dcr_e1_maps',HspFile),
             ('dcr_e2_maps',HspFile),('nexp_maps',HspFile),('ccdtemp_maps',HspFile),('masked_fraction',FitsFile)]
        ...
        for q in quants:
            ...
            for b in bands:
                ...
                if q=='exptime' or q=='nexp':
                    str_hsp_map = self.config['maps_path']+'_'+b+'/'+'testing_'+b+'_'+q+'_sum.hs'
                else:
                    str_hsp_map = self.config['maps_path']+'_'+b+'/'+'testing_'+b+'_'+q+'_wmean.hs'
